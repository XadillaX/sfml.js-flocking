...
const { Vector } = require('p5js-vector-standalone');
...
let boids = [];
const window = new RenderWindow(new VideoMode(720, 400), 'Boids', RenderWindow.Style.Close);
const bgColor = new Color(51, 51, 51);
const circle = new CircleShape(8, 60);
console.log(circle.getPointCount());
circle.setFillColor(new Color(127, 127, 127, 127));
circle.setOutlineColor(new Color(255, 255, 255, 127));
...
for (let i = 0; i < 100; i++) {
  boids[i] = new Boid(getRandomInt(720), getRandomInt(400));
}
